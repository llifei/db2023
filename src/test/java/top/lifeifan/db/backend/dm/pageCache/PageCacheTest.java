...
public class PageCacheTest {
    ...
    private static final String FILE_PC_TEST = "D:\\Projects\\MYDB\\pc_simple_test";

    @Test
    public void testPageCache() throws Exception {
        PageCache pc = PageCache.create(FILE_PC_TEST + 0, PageCache.PAGE_SIZE * 50);
        for(int i = 0 ; i < 100; i ++) {
        ...
        pc = PageCache.open(FILE_PC_TEST + 0, PageCache.PAGE_SIZE * 50);
        for(int i = 1; i <= 100; i ++) {
        ...
        assert new File(FILE_PC_TEST + 0 + ".db").delete();
    }
    ...
    public void testPageCacheMultiSimple() throws Exception {
        pc1 = PageCache.create(FILE_PC_TEST + 1, PageCache.PAGE_SIZE * 50);
        ...
        cdl1.await();
        assert new File(FILE_PC_TEST + 1 + ".db").delete();
    }
    ...
    public void testPageCacheMulti() throws InterruptedException {
        pc2 = PageCache.create(FILE_PC_TEST + 3, PageCache.PAGE_SIZE * 10);
        ...
        assert new File(FILE_PC_TEST + 3 + ".db").delete();
    }
